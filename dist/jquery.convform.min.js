...
ConvState.prototype.printQuestion = function() {
  ...
  setTimeout(
      ...
      if (
        ...
        if (this.next()) {
          setTimeout(
            ...
            Number(this.current.input.delay)||200
          );
        } else {
    ...
    Number(this.current.input.delay) ||500
  );
};
    ...
    var inputs = $(this)
      ...
      .map(function() {
        ...
        if ($(this).attr("currency"))
          input["currency"] = $(this).attr("currency");
        if ($(this).attr("delay"))
          input["delay"] = $(this).attr("delay");
    ...
    if (inputs.length) {
      ...
      $(inputForm)
        ...
        .on("input", function(e) {
          ...
          } else if (state.current.input.hasOwnProperty("currency")) {
            var reg = new RegExp(state.current.input.currency, "i");
            if (reg.test($(this).formatCurrency({roundToDecimalPlace: 0, symbol: '£'}).val())) {
              state.wrapper
                .find(parameters.inputIdHashTagName)
                .removeClass("error");
            } else {
